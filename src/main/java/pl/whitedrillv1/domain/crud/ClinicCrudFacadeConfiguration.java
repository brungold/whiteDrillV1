...
class ClinicCrudFacadeConfiguration {
    ...
    public static ClinicCrudFacade createClinicCrudFacade(
        ...
        AppointmentAdder appointmentAdder = new AppointmentAdder(appointmentRepository,appointmentRetriever, scheduleRetriever, patientRepository, dentistRepository);
